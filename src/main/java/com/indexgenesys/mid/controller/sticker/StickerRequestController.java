 ...
 * @author ernest
 */
@Named(value = "stickerRequestController")
@SessionScoped
public class StickerRequestController implements Serializable, MidMethods {
    ...
    public StickerRequestController() {
    }
    ...
    public void init() {
        lazyRequests = new LazyDataModel<StickerRequest>() {
            ...
            public int count(Map<String, FilterMeta> filters) {
                return stickerRequestFacade.countFiltered(filters);
            }

            @Override
            public List<StickerRequest> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filters) {
                List<StickerRequest> results = stickerRequestFacade.loadLazy(first, pageSize, sortBy, filters);

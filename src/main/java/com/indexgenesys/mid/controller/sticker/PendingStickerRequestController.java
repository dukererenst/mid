 ...
 * @author ernest
 */
@Named(value = "pendingStickerRequestController")
@SessionScoped
public class PendingStickerRequestController implements Serializable, MidMethods {
    ...
    public PendingStickerRequestController() {
    }
    ...
    public void init() {
        lazyRequests = new LazyDataModel<StickerRequest>() {
            ...
            public int count(Map<String, FilterMeta> filters) {
                return stickerRequestFacade.countStatusFiltered(filters, StickerRequestStatus.REQUESTED);
            }

            @Override
            public List<StickerRequest> load(int first, int pageSize, Map<String, SortMeta> sortBy, Map<String, FilterMeta> filters) {
                List<StickerRequest> results = stickerRequestFacade.loadStickerByStatusLazy(first, pageSize, sortBy, filters, StickerRequestStatus.REQUESTED);
